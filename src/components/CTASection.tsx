          ...
          <div className="bg-white border border-gray-200 rounded-xl p-8">
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="group w-full bg-energy-green hover:bg-green-500 text-white font-montserrat font-semibold text-lg px-6 py-4 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center justify-center"
                >
                  Connect With Us
